...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . ifdl5x3out ) , 0 , 0 , 37 } ,
{ ( char_T * ) ( & rtDW . lx5aymxbru . TimePtr ) , 11 , 0 , 13 } , { ( char_T
* ) ( & rtDW . b1hsbjxrwp . PrevIndex ) , 10 , 0 , 5 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . A ) , 0 ,
0 , 480036 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
